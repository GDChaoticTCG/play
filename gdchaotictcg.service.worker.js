...
const CACHE_NAME = "gdchaotictcg-cache";
const OFFLINE_URL = "gdchaotictcg.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["gdchaotictcg.html","gdchaotictcg.js","gdchaotictcg.wasm","gdchaotictcg.pck","gdchaotictcg.offline.html","gdchaotictcg.icon.png","gdchaotictcg.apple-touch-icon.png"];
